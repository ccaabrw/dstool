...
Patch2: dstool_tk-compile_32bit.patch
...
BuildRequires: tcl, tcl-devel, tclx, tclx-devel, tk, tk-devel, perl, imake, glibc-devel.i686, libstdc++-devel.i686, tk-devel.i686, tcl-devel.i686, libX11-devel.i686, tk.i686, tcl.i686
...
ln -s dstool_tk $RPM_BUILD_ROOT%{_bindir}/dstool
...
%changelog
* Fri Nov  9 2018 Brian Watts <b.watts@ucl.ac.uk>
- explicit compile as 32-bit
  create symlonk for dstool -> dstool_tk
